...
public class SereneColor {
    int r, g, b;

    public SereneColor(int r, int g, int b) {
        this.r = r;
        this.g = g;
        this.b = b;
    }

    public SereneColor(int color) {
        this((color >> 16) & 255, (color >> 8) & 255, color & 255);
    }

    public SereneColor(double r, double g, double b) {
    ...
    public static SereneColor convertHSVtoRGB(double h, double s, double v) {
        double hh, p, q, t, ff;
        int i;
        double r, g, b;
